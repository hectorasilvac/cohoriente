...
{block name="body"}
<main>
	<div class="join_us_banner d-xl-none">
	</div>
	<section class="join_us">
		<div class="join_us_wrapper wrap_column">
			<div class="join_us_details">
				<header class="join_us_header container mt-xl-3 h-fit-force">
				...
				<ul class="join_us_list list">
					<li class="info item">
						...
						<div class="w-100p">
							...
							<p class="info_text text">
								Para ser uno de nuestros asociados debes cumplir con todos nuestros requisitos para que
								juntos
					...
					<li class="item">
						<div class="info_icon_wrapper">
							<img class="info_icon" src="{$RESOURCES}img/compressed/icons/benefits.svg"
								alt="Saludo de manos" />
						</div>
						<div class="w-100p">
							<h4 class="info_subtitle subtitle_small">Beneficios</h4>
							<p class="info_text text">
								Por ser parte de nuestro selecto grupo de asociados puedes disfrutar de nuestros
								beneficios.
							</p>
							<p class="link_more">
			...
			<img class="catalog_banner" src="{$RESOURCES}img/compressed/partner_banner.avif"
				alt="Personas estrechando las manos" />
		</div>
	</section>
	...
	<section class="bylaws py-xl-3">
		<div class="bylaws_container container h-fit-force">
			<header>
				<h3 class="bylaws_subtitle subtitle">Conoce Nuestros Estatutos</h3>
				<p class="bylaws_text text_small">
					Cooperativa Regional para la Integración y el Desarrollo de Hospitales e Instituciones de Salud
	...
	<section class="associates">
		<div class="associates_wrapper wrap_column">
			<header class="associates_header container h-fit-force">
				<h3 class="associates_subtitle subtitle">Nuestros Asociados</h3>
			</header>
			<div class="members h-fit-force">
