		...
		<div class="me-xl-6">
			...
			<ul class="row list_styled list_xl_no_styled column-gap-xl-3 row-gap-xl-5">
				<li class="item p-xl-0 mb-xl-0 basis-xl-31">
					...
					<p class="fs-1d4 fs-xl-1d7">Oferta de servicios para el manejo ambiental de residuos
						hospitalarios
						y peligrosos.</p>
				</li>
				<li class="item p-xl-0 mb-xl-0 basis-xl-31">
					...
					<p class="fs-1d4 fs-xl-1d7">Oferta de medicamentos POS y No POS.</p>
				</li>
				<li class="item p-xl-0 mb-xl-0 basis-xl-31">
					<div class="wrap_icon bg-primary flex-center me-2 wrap_icon_xl me-xl-1d4">
					...
					<p class="fs-1d4 fs-xl-1d7">Convenios de acercamiento al sistema de Salud y recuperación de cartera.</p>
				</li>
				<li class="item p-xl-0 mb-xl-0 basis-xl-31">
					<div class="wrap_icon bg-primary flex-center me-2 wrap_icon_xl me-xl-1d4">
						<img class="icon_item icon_xl" src="{$RESOURCES}img/compressed/icons/molecule.svg" alt="Moléculas" />
					</div>
					<p class="fs-1d4 fs-xl-1d7">Oferta de tecnología biomédica.</p>
				</li>
				<li class="item p-xl-0 mb-xl-0 basis-xl-31">
					<div class="wrap_icon bg-primary flex-center me-2 wrap_icon_xl me-xl-1d4">
				...
				<li class="item p-xl-0 mb-xl-0 basis-xl-31">
					...
					<p class="fs-1d4 fs-xl-1d7">Oferta de dispositivos médicos e insumos.</p>
				</li>
				<li class="item p-xl-0 mb-xl-0 basis-xl-31">
					<div class="wrap_icon bg-primary flex-center me-2 wrap_icon_xl me-xl-1d4">
