...
<main class="bg--secondary300 ht-fill">
	...
	<section class="abt_grid wrapper wrap_quaternary">
		<!-- Mission -->
		<details class="card mb-1d5">
			<summary class="about_card_header d-flex justify-content-between">
				<div class="d-flex">
					<img class="wd-2d3 ht-2d1" src="{$RESOURCES}img/icons/mission_icon.svg"
						alt="Ícono de una diana con un dardo">
					<h3 class="abt_mission text_large color--primary ml-d5">Misión</h3>
				</div>
		...
		<details class="card mb-1d5">
			<summary class="about_card_header d-flex justify-content-between">
				<div class="d-flex">
					...
					<h3 class="abt_vision text_large color--primary ml-d5">Visión</h3>
				</div>
				<i class="about_card_icon fas fa-angle-double-down fa-2x color--secondary430"></i>
			</summary>
			<p class="text text--justify mt-2">
