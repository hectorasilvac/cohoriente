...
<section class="carousel">
	<div class="carousel_container container">
        <img class="banner_text" src="{$RESOURCES}img/main_banner_text.png" alt="Ícono de Vara de Esculapio">
        <img class="banner_text" src="{$RESOURCES}img/main_banner_bg.png" alt="Ícono de Vara de Esculapio">
    </div>
</section>
<section class="order">
</section>
<section class="location">
	<div class="location_container container">
		...
		<img class="location_image" src="{$RESOURCES}img/world.png" alt="Imagen de planeta destacando el territorio de Colombia" />
	</div>
</section>
...
<section class="employee">
	<div class="employee_container container">
		...
		<img src="{$RESOURCES}img/employee_img.png" alt="Foto frontal de Cristopher Solano" />
	</div>
</section>
<section class="team">
	<div class="team_container container">
		...
		<img class="team_image" src="{$RESOURCES}img/our_team.png" alt="Mapa de Servicios ofrecidos por Cohoriente" />
	</div>
</section>
	...
	<div class="partner_container container">
		...
		<div class="partner_carousel">
			<div class="partner_carousel_cell">
				<img class="partner_carousel_img" src="{$RESOURCES}img/partner_carousel/hospital_manuela_beltran.png" alt="Logo del Hospital Manuela Beltran " />
			</div>
			<div class="partner_carousel_cell">
				<img class="partner_carousel_img" src="{$RESOURCES}img/partner_carousel/hospital_san_camilo.svg" alt="Logo del Hospital Psiquiátrico San Camilo"/>
			</div>
			<div class="partner_carousel_cell">
				<img class="partner_carousel_img" src="{$RESOURCES}img/partner_carousel/hospital_garcia_rovira.png" alt="Logo del Hospital Garcia Rovira" />
			</div>
			<div class="partner_carousel_cell">
				<img class="partner_carousel_img" src="{$RESOURCES}img/partner_carousel/hospital_piedecuesta.png" alt="Logo del Hospital Local de Piedecuesta" />
			</div>
		</div>
	</div>
</section>
	...
	<div class="contact_container container">
		<div class="find_us">
			...
			<div class="info_location_item wrapper">
				<img class="info_location_icon icon" src="{$RESOURCES}img/icons/location-outline.svg" alt="Ícono de Ubicación" />
			...
			<div class="info_location_center wrapper">
				<img class="info_location_icon icon" src="{$RESOURCES}img/icons/call-outline.svg" alt="Ícono de Teléfono" />
				<p class="info_location_text text">(57) 315 378 5627</p>
			</div>
			<div class="info_location_center wrapper">
				<img class="info_location_icon icon" src="{$RESOURCES}img/icons/mail-outline.svg" alt="Ícono de Correo Electrónico" />
